...
TG_BOT_TOKEN = os.environ.get("TG_BOT_TOKEN", "5851193592:AAGXxlT2ca4GHi85gtY9v3VR89EcuQRBn7Y")
...
# ID Channel Database
CHANNEL_ID = int(os.environ.get("CHANNEL_ID", "-1001902751292"))
...
FORCE_SUB_CHANNEL = int(os.environ.get("FORCE_SUB_CHANNEL", "-1002143048680"))
FORCE_SUB_GROUP = int(os.environ.get("FORCE_SUB_GROUP", "-1001190580922"))
